...
def generate_arrays(length):
    ...
    for num in range(0, 100):
        #print(f"making array num---> {num}")
        lil_array_holder = []
        for _ in range(length):
            value = randint(1, 100)
            lil_array_holder.append(value)
        #print(f"The size of lil_array_holder is --> {len(lil_array_holder)}")
        big_ol_array.append(lil_array_holder)
    return big_ol_array
    #pprint.pprint(big_ol_array)
    #print(f"The size of our big_ol_array is ---> {len(big_ol_array)}")
...
def main():
    ...
    #found, time = binary_search_recursive(sorted_500, -1)
    #print("Sequential search 500 took %10.7f seconds to run, on average." %time)
    #found, time = binary_search_recursive(sorted_1000, -1)
    #print("Sequential search 1000 took %10.7f seconds to run, on average." %time)
    #found, time = binary_search_recursive(sorted_10000, -1)
    #print("Sequential search 10000 took %10.7f seconds to run, on average." %time)
